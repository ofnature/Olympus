...
public class KardiaModuleDirectDispatchTests
{
    private readonly KardiaModule _module = new();

    [Fact]
    public void CollectCandidates_OocKardionAlreadyOnTank_DoesNotExecuteKardia()
    {
        ...
        actionService.Verify(
            ...
            Times.Never);
        Assert.Equal("Kardion on tank (pre-pull)", context.Debug.KardiaState);
    }
}
