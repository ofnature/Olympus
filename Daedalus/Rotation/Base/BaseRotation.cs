    ...
    where TModule : IRotationModule<TContext>
{
    ...
    protected readonly Daedalus.Services.Consumables.ITinctureDispatcher? TinctureDispatcher;
    protected readonly Daedalus.Rotation.Common.Modules.PrePullModule? PrePullModule;
        ...
        Daedalus.Services.Pull.IPullIntentService? pullIntentService = null)
    {
        ...
        {
            PrePullModule = new Daedalus.Rotation.Common.Modules.PrePullModule(pullIntentService);
            PrePullModule.Register(new Daedalus.Rotation.Common.Modules.TinctureCandidate(tinctureDispatcher));
        }
    }
